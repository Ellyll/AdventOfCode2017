...
let numberOfConfigs, config = getNumberOfConfigurations (Set.empty) 0 memoryBanks
printfn "Number of initial steps: %i, config: %A" numberOfConfigs config

let numberOfConfigs2, config2 = getNumberOfConfigurations (Set.empty) 0 config
printfn "Number of repeat steps: %i, config: %A" numberOfConfigs2 config2
